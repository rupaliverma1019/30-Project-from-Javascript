...
console.log(zodiac.dailyHoroscope.luckyNumber)
}
...
document.getElementById("Lnumber").textContent = `Your Lucky Number: ${zodiac.dailyHoroscope.luckyNumber}`;
document.getElementById("Lcolor").textContent = `Your Lucky coor: ${zodiac.dailyHoroscope.luckyColor}`;
  })
